...
*   [**Portal Landing Page**](https://<your-username>.github.io/<your-repo>/) - Overview of the project and access to all visualizations.
*   [**Map 1: Primary Spatial Trends**](https://<your-username>.github.io/<your-repo>/map1.html) - *[Brief 1-sentence description, e.g., Regional waste generation per capita across Peru's 24 departments.]*
*   [**Map 2: Infrastructure & Sourcing**](https://<your-username>.github.io/<your-repo>/map2.html) - *[Brief 1-sentence description, e.g., Locations of authorized landfills vs. open dumpsites.]*
...
*   **Interactive Mapping:** *[Insert your library here, e.g., Leaflet, Folium, or Mapbox]*
